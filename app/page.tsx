    ...
    <main>
      <section className="hero" id="inicio">
        ...
        <div className="heroVisual">
          <Image src="/hero.jpg" alt="Diseño de Ángela España en Cancún" fill priority sizes="(max-width: 900px) 100vw, 47vw" />
      ...
      <section className="editorial" aria-label="Universo Ángela España">
        <figure className="large"><Image src="/galeria4.jpg" alt="Diseño blanco de Ángela España" fill sizes="(max-width: 900px) 100vw, 56vw" /><figcaption>Ángela España · Archivo</figcaption></figure>
        <div className="stack">
          <figure><Image src="/galeria2.jpg" alt="Conjunto de Ángela España" fill sizes="(max-width: 560px) 100vw, 42vw" /><figcaption>Hecho para sentirse propio</figcaption></figure>
          <figure><Image src="/galeria3.jpg" alt="Look de Ángela España" fill sizes="(max-width: 560px) 100vw, 42vw" /><figcaption>Detalles con intención</figcaption></figure>
        </div>
      </section>
      <section className="offer" id="como-comprar">
        <div className="offerVisual"><Image src="/acento.jpg" alt="Prenda artesanal de Ángela España" fill sizes="(max-width: 900px) 100vw, 50vw" /></div>
